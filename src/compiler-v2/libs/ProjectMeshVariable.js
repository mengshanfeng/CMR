...
/*********************  CLASS  **********************/
function ProjectMeshVariable(latexName, longName, type, ghostCnt, id )
{
	if (id == undefined)
		id = 0;
	this.id = id;
...
/*******************  FUNCTION  *********************/
ProjectMeshVariable.prototype.toDebugString = function( data )
{
	//default
...
/*******************  FUNCTION  *********************/
ProjectMeshVariable.prototype.render = function( templateFactory , codeType , context, latexEntity)
{
	var data = {
		object: this,
		context:context,
	...
	return templateFactory.render("mesh_variable",codeType,data);
}

/*******************  FUNCTION  *********************/
ProjectMeshVariable.prototype.getUsageOps = function(context,latexEntity,write)
{
	//error
	if (this.write)
...
/*******************  FUNCTION  *********************/
ProjectMeshVariable.prototype.genAccessCCode = function(context,entity,write)
{
	var ret = {
...
// 
// /*******************  FUNCTION  *********************/
// void ProjectMeshVariable::printValues ( ostream& out ) const
// {
// 	switch(dims.size())
// 	{
// 		case 0:
...
// 
// /*******************  FUNCTION  *********************/
// void ProjectMeshVariable::transform ( void )
// {
...
// 
// /*******************  FUNCTION  *********************/
// void ProjectMeshVariable::transform ( LatexFormulas& formula, CMRModelBasedReplacement& action )
// {
...
// 
// /*******************  FUNCTION  *********************/
// void ProjectMeshVariable::transform ( LatexEntity& entity, CMRModelBasedReplacement& action )
// {
// 	action.apply(entity);
// 	
...
/********************  GLOBALS  *********************/
module.exports = ProjectMeshVariable;
