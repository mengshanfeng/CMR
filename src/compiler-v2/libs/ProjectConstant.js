...
/*********************  CLASS  **********************/
function ProjectConstant(latexName,longName,type)
{
...
/*******************  FUNCTION  *********************/
ProjectConstant.prototype.loadValues = function(data,dimensions)
{
...
/*******************  FUNCTION  *********************/
ProjectConstant.prototype.loadValuesScalar = function(data)
{
	//errors
		//errors
...
/*******************  FUNCTION  *********************/
ProjectConstant.prototype.loadValuesVector = function( data )
{
	//errors
	if(data == "")
		throw new Error("Invalid empty data to be loaded as scalar !");
...
/*******************  FUNCTION  *********************/
ProjectConstant.prototype.loadValuesMatrix = function( data )
{
	//vars
	var dim1 = -1;
	var dim2 = -1;
...
/*******************  FUNCTION  *********************/
ProjectConstant.prototype.addDimension = function( size )
{
	this.dims.push(size);
...
/*******************  FUNCTION  *********************/
ProjectConstant.prototype.toDebugString = function( data )
{
	//default
...
/*******************  FUNCTION  *********************/
ProjectConstant.prototype.getUsageOps = function(context,latexEntity,write)
{
	//error
	if (this.write)
...
/********************  GLOBALS  *********************/
module.exports = ProjectConstant;
