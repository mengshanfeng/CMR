...
class svutException : public std::exception
{
	public:
		...
		svutException(std::string message) throw() {this->message = message;};
		virtual ~svutException(void) throw() {};
		virtual const char* what() const  throw() {return message.c_str();};
		virtual std::string getMessage(void) const {return message;};
	private:
...
class svutArgp
{
	public:
		...
		void declareOption(char key,std::string name,std::string valueType,std::string descr) throw (svutExArgpDuplicateKey);
